...
prePrelude =
   ...
   , ("slice", Abstr "xs" (Abstr "begin" (Abstr "end" (Case (Op Lt (Var "begin") (Value (Con 1))) [(PVal (Boolean True),Value Empty),(PVal (Boolean False),Case (Op Gt (Var "begin") (App (Var "length") (Var "xs"))) [(PVal (Boolean True),Value Empty),(PVal (Boolean False),Case (Op Lt (Var "end") (Value (Con 1))) [(PVal (Boolean True),Value Empty),(PVal (Boolean False),Case (Op Or (Op Lt (Var "begin") (Var "end")) (Op Eq (Var "begin") (Var "end"))) [(PVal (Boolean True),App (App (Var "drop") (Op Sub (Var "begin") (Value (Con 1)))) (App (App (Var "take") (Var "end")) (Var "xs"))),(PVal (Boolean False),LetRec "beginP" (Op Add (Op Sub (App (Var "length") (Var "xs")) (Var "begin")) (Value (Con 1))) (LetRec "endP" (Op Add (Op Sub (App (Var "length") (Var "xs")) (Var "end")) (Value (Con 1))) (App (App (Var "drop") (Op Sub (Var "beginP") (Value (Con 1)))) (App (App (Var "take") (Var "endP")) (App (Var "reverse") (Var "xs"))))))])])])])))) 
